...
use MyJobs\CoreBundle\Entity\Contract;
...
class AdminContractController extends Controller
{
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('MyJobs\CoreBundle\Form\ContractType', $contract);
        ...
        return $this->render('MyJobsAdminBundle:Admin:contract/new.html.twig', array(
            'contract' => $contract,
    ...
    public function showAction(Contract $contract)
    {
        ...
        return $this->render('MyJobsAdminBundle:Admin:contract/show.html.twig', array(
            'contract' => $contract,
    ...
    {
        $deleteForm = $this->createDeleteForm($contract);
        $editForm = $this->createForm('MyJobs\CoreBundle\Form\ContractType', $contract);
